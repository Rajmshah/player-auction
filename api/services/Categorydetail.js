...
var exports = _.cloneDeep(require("sails-wohlig-service")(schema, "team category", "team category"));
var model = {
    uploadExcel: function (importData, callback) {
        ...
        async.waterfall([
                ...
                function (saveInfo, callback) {
                    async.concatSeries(saveInfo, function (singleData, callback) {
    ...
    generateExcel: function (data, res) {
        ...
        obj.Name = 'Raj Shah';
        obj.Age = 26;
        obj.Image = 'https://storage.googleapis.com/auction-player/d8e7cc68-bcbb-4118-a5c1-8353dc44601f.jpg'
        obj.Village = 'Kutch'
        obj.Category = 'Ghi';
